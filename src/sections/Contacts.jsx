...
<div className="">
        ...
        <div className="flex gap-3 justify-center FaqDiv">
            ...
            <h2 className='text-[22px] text-[#F3F5FB] contactH2'>Сертификаты</h2>
        </div>

        <h1 className='mobileH1contacts text-7xl text-[#F3F5FB] text-center mt-5 pb-[144px] font-medium'>Сертификаты</h1>
        <h1 className='mobileContacts text-7xl text-[#F3F5FB] text-center mt-8 pb-[144px] font-medium'>Плоская кровля
в Новосибирске и области</h1>
      </div>  
</div>

             <div className="flex items-start gap-[200px] px-42 py-14 ContactsMain">
                 <div className="bg-[#11183A0D] w-30 p-2 rounded-[10px] flex justify-center relative top-2 footerDiv">
            <p className='text-[16px] text-[#11183A4D] footerP1'>Наши данные</p>
          </div>
          <div className="">
    
          <h1 className=' text-[42px] text-[#11183A] font-medium leading-tight w-[460px] footerH1'>Как с нами связаться</h1>
          <div className="mt-14 footerUL">
            {info.map((element, index) => (
                <div key={index} className="flex items-center gap-3.5 mb-3.5 footerP">
                    <img src={element.icon} alt="" />
                    <p className='text-[#11183A80] footerP2'>{element.name}</p>
                </div>
            ))}
          </div>
          <div className="flex items-center gap-8 footerDivquestion">
            <h2 className='text-[#11183A] text-[30px] footerH2'>Остались вопросы?</h2>
            <div className="flex mt-[10px]  relative left-[-20px] footerinput">
            
                    <HiPhone color='#11183A33' size={'18px'} className='relative top-4 left-8'/>
                    <input type="text" placeholder='Ваш телефон' className='inputRegis relative text-[16px] text-[#11183A33] px-[41px] py-[11px]  bg-[#11183A1A] border-2 border-[#F3F5FB99] rounded-[10px]'/>
            </div>
          ...
          <div className="">
             <div className='rounded-[10px] w-[828px] h-[300px] mt-7 map2' style={{ position: 'relative', overflow: 'hidden' }}>
          <a
          ...
          <div className="mt-14 FooterContact">
